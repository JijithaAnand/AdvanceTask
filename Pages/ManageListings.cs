...
namespace MarsFramework.Pages
{
    internal class ManageListings
    {
        ...
        {
            //(Path.Combine(Base.ExcelPath, @"TestDataManageListings.xlsx"), "ViewSkill");
            GlobalDefinitions.ExcelLib.PopulateInCollection(Path.Combine(Base.ExcelPath, @"TestDataManageListings.xlsx"), "ViewSkill");
        ...
        internal void ClickDelete()
        {
            ...
            GlobalDefinitions.ExcelLib.PopulateInCollection(Path.Combine(Base.ExcelPath, @"TestDataManageListings.xlsx"), "DeleteSkill");
            int counts = 0;
            counts = Global.GlobalDefinitions.Driver.FindElements(By.XPath("/html/body/div/div/div/div[2]/div[1]/div[1]/table/tbody/tr")).Count;
            int check = 0;
            if (counts !=0)
        ...
        internal void EditListing()
        {
            ...
            GlobalDefinitions.ExcelLib.PopulateInCollection(Path.Combine(Base.ExcelPath, @"TestDataManageListings.xlsx"), "EditManageListings");
            int counts = 0;
            counts = Global.GlobalDefinitions.Driver.FindElements(By.XPath("/html/body/div/div/div/div[2]/div[1]/div[1]/table/tbody/tr")).Count;
            int check = 0;
            if(counts!=0)

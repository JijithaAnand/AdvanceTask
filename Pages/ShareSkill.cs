...
namespace MarsFramework.Pages
{
    internal class ShareSkill
    {
        ...
        {
            int rows;
            rows = GlobalDefinitions.ExcelLib.NumberofRows(Path.Combine(Base.ExcelPath, @"TestDataShareSkill.xlsx"), "ShareSkill");
            //Populate the excel data
            GlobalDefinitions.ExcelLib.PopulateInCollection(Path.Combine(Base.ExcelPath, @"TestDataShareSkill.xlsx"), "ShareSkill");
            Thread.Sleep(1500);
